...
if(!(new File("plugins/tWizT3dLib/ColorMeUserData/Players.yml").exists())){
	try {
		new File("plugins/tWizT3dLib/ColorMeUserData/Players.yml").createNewFile();
	} catch (IOException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
}
Config =new File("plugins/tWizT3dLib/ColorMeUserData/Players.yml");
